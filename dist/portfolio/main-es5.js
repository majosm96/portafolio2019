(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectComponent = /** @class */ (function () {
                function ProjectComponent(route, sanitizer) {
                    this.route = route;
                ...
                ProjectComponent.prototype.sanitizerUrl = function (url) {
                    return this.sanitizer.bypassSecurityTrustResourceUrl(url);
                };
                ProjectComponent.prototype.ngOnInit = function () {
                    window.scroll(0, 0); // Goes to page top
                    var projectId = Number(this.route.snapshot.paramMap.get('id'));
                    this.selectedProject = this.projects.find(function (p) { return p.id === projectId; });
                };
