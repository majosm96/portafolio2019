...
export class ProjectComponent implements OnInit {
  ...
  public projects = [{
    ...
    // section2: {
    //   title: 'PayPal & Iframe field',
    //   info: 'Pay Method was integrated with paypal and iframe fields was enabled in order to put any youtube or vimeo link.',
    //   img: '/assets/images/conversable-screen03-big.jpg'
    // }
  },
  {
    id: 2,
